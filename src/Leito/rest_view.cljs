(ns Leito.rest-view
  (:require  [reagent.core :as r]
             ...
             [cljs.repl :as repl]
             [cljs.pprint :as pp]
             [Leito.rest-evs :as evs]
             [Leito.rest-subs :as subs]
             [Leito.rest-core]
  ...
  (let [default-value ""
    ...
    (fn []
      [react-ace {:name "rest-editor-data"
                  ...
                  :value @av
                  :on-load (fn [ref]
                             (rf/dispatch [:Leito.rest-core/set-editor-preserve [:data ref] ])
  ...
  (let [default-value ""
    ...
    (fn []
      [react-ace {:name "rest-editor-response"
                  ...
                  :value @av
                  :on-load (fn [ref]
                             (rf/dispatch [:Leito.rest-core/set-editor-preserve [:response ref]])
  ...
  (let []
    (fn []
      [:section
       ...
       #_[Leito.rest-sample/sample-table]])))
